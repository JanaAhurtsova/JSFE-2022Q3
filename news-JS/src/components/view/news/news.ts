...
class News implements NewsInt {
    public draw(data: DataNews[]): void {
        ...
        news.forEach((item: DataNews, idx: number) => {
            ...
            const newsMetaAuthor = newsClone.querySelector('.news__meta-author') as HTMLDivElement;
            ...
            const newsDescriptionRedMore = newsClone.querySelector('.news__description-read-more a') as HTMLElement;
            ...
            newsDescriptionRedMore && newsDescriptionRedMore.setAttribute('href', item.url);
