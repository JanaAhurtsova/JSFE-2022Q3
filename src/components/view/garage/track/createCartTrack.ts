    ...
    <div class="road">
      <div class="road__wrapper">
        <div class="controls-track">
          <button class="button start-engine__button" id="start-engine-car-${id}" ${isEngineStarted ? "disabled" : ""}> A </button>
          <button class="button stop-engine__button" id="stop-engine-car-${id}" ${isEngineStarted ? "" : "disabled"}> B </button>
        </div>
